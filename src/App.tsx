            ...
            <div class="card">
              ...
              <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                <div style="display: flex; gap: 15px; align-items: baseline;">
                  ...
                  <div style="display: flex; flex-direction: column; font-size: 10px; color: #6B7280; font-weight: bold; gap: 2px;">
                    <span id="ui-price-m1">C2: ---</span>
                    <span id="ui-price-m2">C3: ---</span>
                    <span id="ui-price-m3">C4: ---</span>
                  </div>
                </div>
                <div style="display: flex; gap: 15px; align-items: flex-end;">
                  <div style="display: flex; flex-direction: column; align-items: center; gap: 2px;">
                    <div style="font-size: 8px; font-weight: bold; color: #6B7280;">SIGNAL</div>
                    <div id="ui-signal-bars" style="display: flex; align-items: flex-end; gap: 2px; height: 20px;">
                      <div style="width: 4px; height: 4px; background: #111827; border-radius: 1px;"></div>
                      <div style="width: 4px; height: 8px; background: #111827; border-radius: 1px;"></div>
                      <div style="width: 4px; height: 12px; background: #111827; border-radius: 1px;"></div>
                      <div style="width: 4px; height: 16px; background: #D1D5DB; border-radius: 1px;"></div>
                      <div style="width: 4px; height: 20px; background: #D1D5DB; border-radius: 1px;"></div>
                    </div>
                  </div>
                  <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 2px;">
                    <div style="font-size: 8px; font-weight: bold; color: #6B7280;">TAB RAM</div>
                    <div style="position: relative; width: 60px; height: 20px; border: 1px solid #E5E7EB; background: #FFF;">
                      <canvas id="ui-ram-canvas" width="60" height="20" style="display: block;"></canvas>
                      <div id="ui-ram-text" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 8px; font-weight: bold; color: #000; pointer-events: none;">--</div>
                    </div>
                  </div>
                  <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 2px;">
                    <div style="font-size: 8px; font-weight: bold; color: #6B7280;">SYS RAM</div>
                    <div style="position: relative; width: 60px; height: 20px; border: 1px solid #E5E7EB; background: #FFF;">
                      <canvas id="ui-sys-ram-canvas" width="60" height="20" style="display: block;"></canvas>
                      <div id="ui-sys-ram-text" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 8px; font-weight: bold; color: #000; pointer-events: none;">--</div>
                    </div>
                  </div>
                </div>
              </div>
