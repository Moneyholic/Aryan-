...
if (!window.karenBotInjected) {
    ...
    function processTick(price) {
        ...
        updateIndicators();
        if (isIframe) { window.parent.postMessage({ type: 'KAREN_STATUS', asset: state.activeAsset, signal: state.currentSignal, price: state.livePrice, macd: state.macd, candle: state.currentCandle }, '*'); }
        if (isIframe) { window.parent.postMessage({ type: 'KAREN_STATUS', asset: state.activeAsset, signal: state.currentSignal, price: state.livePrice, macd: state.macd, candle: state.currentCandle }, '*'); }
    }
    ...
    function initUI() {
        if (isIframe) {
            ...
            overlay.innerText = '👆 Select an asset for this chart';
            document.body.appendChild(overlay);
            return; 
        }
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          #maximized { display: flex; width: 100%; max-width: 360px; max-height: 90vh; background: #FAFAFA; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.15); border: 1px solid #E5E7EB; flex-direction: column; overflow: hidden; }
          ...
          .content { padding: 12px; overflow-y: auto; display: flex; flex-direction: column; gap: 12px; overscroll-behavior: contain; -webkit-overflow-scrolling: touch; }
          ...
          :host(.fullscreen) #maximized { width: 100vw; height: 100vh; max-height: 100vh; border-radius: 0; }
          :host(.fullscreen) .charts-grid { display: grid; grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr; gap: 12px; height: 100%; }
          :host(.fullscreen) .content { max-height: calc(100vh - 50px); height: calc(100vh - 50px); }
        ...
        <div id="maximized">
          <div class="header" id="drag-header">
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              ...
              <button class="collapse-btn" id="btn-fullscreen" style="margin-right: 4px;">⛶</button>
          ...
          <div class="content">
            ...
            <div class="card" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
              <div class="card-title" style="width: 100%;">Telegram Settings</div>
              ...
              <div style="display: flex; justify-content: space-around; width: 100%; flex-wrap: wrap; gap: 10px;">
                  <div style="display: flex; flex-direction: column; align-items: center;">
                      ...
                      <div class="signal-circle-wrapper" style="width: 60px; height: 60px;">
                          <div class="signal-circle-spinner paused" id="ui-signal-spinner-0" style="border-width: 4px;"></div>
                  ...
                  <div style="display: flex; flex-direction: column; align-items: center;">
                      ...
                      <div class="signal-circle-wrapper" style="width: 60px; height: 60px;">
                          <div class="signal-circle-spinner paused" id="ui-signal-spinner-1" style="border-width: 4px;"></div>
                  ...
                  <div style="display: flex; flex-direction: column; align-items: center;">
                      ...
                      <div class="signal-circle-wrapper" style="width: 60px; height: 60px;">
                          <div class="signal-circle-spinner paused" id="ui-signal-spinner-2" style="border-width: 4px;"></div>
                  ...
                  <div style="display: flex; flex-direction: column; align-items: center;">
                      ...
                      <div class="signal-circle-wrapper" style="width: 60px; height: 60px;">
                          <div class="signal-circle-spinner paused" id="ui-signal-spinner-3" style="border-width: 4px;"></div>
...
if (currentMacd.line < -threshold) {
    ...
    if (host && host.shadowRoot) {
        ...
        el('btn-toggle').addEventListener('click', () => {
            ...
            const iframes = document.querySelectorAll('#iframe-grid iframe');
        ...
        if (btnLaunchServer) {
            btnLaunchServer.addEventListener('click', () => {
                ...
                assetList.innerHTML = '';
                const availableAssets = Array.from(state.ignoredAssets || []).filter(a => a !== 'DOGUSD_OTC' && a !== 'BTCUSD_OTC').sort();
        ...
        if (btnLaunchCharts) {
            btnLaunchCharts.addEventListener('click', () => {
                ...
                selectedAssetsForMinions.forEach((asset, i) => {
                    ...
                    label.style.cssText = 'position: absolute; top: -10px; left: 10px; background: #fff; padding: 0 8px; font-size: 12px; font-weight: bold; color: #374151; z-index: 2; border: 1px solid #E5E7EB; border-radius: 4px;';
                    label.innerText = '#Chart ' + (i + 2) + ' (' + asset + ')';
